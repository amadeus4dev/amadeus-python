...
from amadeus_sdk.client.errors import ParserError, ServerError
from amadeus_sdk.client.errors import AuthenticationError, NetworkError
from amadeus_sdk.client.errors import NotFoundError, ClientError
